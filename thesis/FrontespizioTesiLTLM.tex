...
\begin{textblock*}{21cm}(0cm,9.97cm)
	\fontsize{18}{22}\selectfont
	\centerline {\textit{Corso di Laurea d'Informatica}}
\end{textblock*}


\begin{textblock*}{21cm}(0cm,13.66cm)
	\fontsize{20}{24}\selectfont
	\centerline  {\textbf{Attacchi informatici con l'intelligenza artificiale}}
\end{textblock*}
...
\begin{textblock*}{8cm}(12.33cm,23.55cm)
    \noindent {\fontsize{12}{14}\selectfont \textbf{Barrios Luna Victoria Luis Andre}\par}
\end{textblock*}
